...
import uk.ac.cam.vap32.mlrd.exercises.Exercise6;

public class Exercise6Tester {

    static final Path dataDirectory = Paths.get("C:\\Users\\victo\\Desktop\\DataML\\nuanced_sentiment_dataset");
    ...
    public static void main(String[] args) throws IOException {
        ...
        Path classPredictionsFile = Paths.get("C:\\Users\\victo\\Desktop\\DataML\\class_predictions.csv");
